    ...
    public static SettingsProvider CreateSettingsProvider()
    {
        SettingsProvider settingsProvider = new SettingsProvider("Project/RoadCreator", SettingsScope.Project)
        {
            ...
            guiHandler = (searchContext) =>
            {
                ...
                settings.FindProperty("defaultBridgePillarPrefab").objectReferenceValue = (GameObject)EditorGUILayout.ObjectField("Default Spaced Bridge Pillar Prefab", settings.FindProperty("defaultBridgePillarPrefab").objectReferenceValue, typeof(GameObject), false);
                settings.FindProperty("defaultConnectedBridgePillarPrefab").objectReferenceValue = (GameObject)EditorGUILayout.ObjectField("Default Connected Bridge Pillar Prefab", settings.FindProperty("defaultConnectedBridgePillarPrefab").objectReferenceValue, typeof(GameObject), false);
                ...
                if (GUILayout.Button("Reset Default Values"))
                {
                    ...
                    settings.FindProperty("defaultConnectedBridgePillarPrefab").objectReferenceValue = null;
